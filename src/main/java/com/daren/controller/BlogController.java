...
import com.daren.entity.Blog;
import com.daren.service.IBlogService;
...
//                .setSql("liked = liked + 1").eq("id", id).update();
    ...
    public Result queryBlogOfFollow(@RequestParam("lastId") Long timestamp, @RequestParam(value = "offset", defaultValue = "0") Integer offset) {
        return blogService.queryBlogOfFollow(timestamp, offset);
    }
}
