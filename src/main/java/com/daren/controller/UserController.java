...
import com.daren.service.IUserInfoService;
import com.daren.service.IUserService;
import com.daren.service.impl.BlogServiceImpl;
...
/*    // ... 在类里面执行
    ...
    public String checkConfig() {
        // 如果这里打印出来是 null，说明 Spring 根本没读到你的 yml 配置
        System.out.println("-----------------------------------------------------------------------------------NameServer 地址是: " + rocketMQProperties.getNameServer());
